...
class Embed(Area):
    ...
    def create(self, attributes):
        ...
        return self.transport.POST(
            url="/embed/", body=attributes, type="application/json"
        )
...
class Search(Area):
    ...
    def searchApp(self, app_id, attributes):
        ...
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/search/app/%d/" % app_id, body=attributes, type="application/json"
        )
...
class Item(Area):
    ...
    def find_all_by_external_id(self, app_id, external_id):
        return self.transport.GET(
            url="/item/app/%d/v2/?external_id=%r" % (app_id, external_id)
        )
    ...
    def revision_difference(self, item_id, revision_from_id, revision_to_id):
        return self.transport.GET(
            url="/item/%d/revision/%d/%d" % (item_id, revision_from_id, revision_to_id)
        )
    ...
    def create(self, app_id, attributes, silent=False, hook=True):
        ...
        return self.transport.POST(
            ...
            type="application/json",
            url="/item/app/%d/%s"
            % (app_id, self.get_options(silent=silent, hook=hook)),
        )
    ...
    def update(self, item_id, attributes, silent=False, hook=True):
        ...
        return self.transport.PUT(
            body=attributes,
            type="application/json",
            url="/item/%d%s" % (item_id, self.get_options(silent=silent, hook=hook)),
        )
...
class Application(Area):
    ...
    def create(self, attributes):
        ...
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/app/", body=attributes, type="application/json"
        )
...
class Task(Area):
    ...
    def create(self, attributes, silent=False, hook=True):
        ...
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/task/%s" % self.get_options(silent=silent, hook=hook),
            body=attributes,
            type="application/json",
        )
    ...
    def create_for(self, ref_type, ref_id, attributes, silent=False, hook=True):
        ...
        return self.transport.POST(
            ...
            type="application/json",
            url="/task/%s/%s/%s"
            % (ref_type, ref_id, self.get_options(silent=silent, hook=hook)),
        )
...
class Status(Area):
    ...
    def create(self, space_id, attributes):
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/status/space/%s/" % space_id, body=attributes, type="application/json"
        )
...
class Space(Area):
    ...
    def create(self, attributes):
        ...
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/space/", body=attributes, type="application/json"
        )
...
class Connection(Area):
    def create(self, attributes):
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/connection/", body=attributes, type="application/json"
        )
...
class Conversation(Area):
    ...
    def create(self, attributes):
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/conversation/", body=attributes, type="application/json"
        )
...
class Files(Area):
    ...
    def attach(self, file_id, ref_type, ref_id):
        attributes = {"ref_type": ref_type, "ref_id": ref_id}
        return self.transport.POST(
            url="/file/%s/attach" % file_id,
    ...
    def create(self, filename, filedata):
        ...
        attributes = {"filename": filename, "source": filedata}
        return self.transport.POST(
...
class View(Area):
    def create(self, app_id, attributes):
        ...
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/view/app/{}/".format(app_id), body=attributes, type="application/json"
        )
    ...
    def get_views(self, app_id, include_standard_views=False):
        ...
        return self.transport.GET(
            url="/view/app/{}/?include_standard_views={}".format(
                app_id, include_standard
            )
        )
    ...
    def update_last_view(self, app_id, attributes):
        ...
        return self.transport.PUT(
            url="/view/app/{}/last".format(app_id),
            body=attribute_data,
            type="application/json",
        )
    ...
    def update_view(self, view_id, attributes):
        ...
        attribute_data = json.dumps(attributes)
        return self.transport.PUT(
            url="/view/{}".format(view_id), body=attribute_data, type="application/json"
        )
...
class Comment(Area):
    def create(self, ref_type, ref_id, attributes, silent=False, hook=True):
        ...
        attributes = json.dumps(attributes)
        return self.transport.POST(
            url="/comment/{}/{}/".format(ref_type, ref_id)
            + self.get_options(silent=silent, hook=hook),
            body=attributes,
            type="application/json",
        )
    ...
    def update(self, comment_id, attributes, silent=False, hook=True):
        ...
        return self.transport.PUT(
            ...
            type="application/json",
            url="/comment/%d%s"
            % (comment_id, self.get_options(silent=silent, hook=hook)),
        )
